...
public class Login_Page_Android extends DriverManager
{
    ...
    public void TC_002()
    {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.id("com.moai.android:id/edtMobileNumber"))).sendKeys("0000000000");

        /* 2.country code is present in the screen or not.  Important - country code is not available in other devices*/
        WebElement countryCode = wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.id("com.moai.android:id/textinput_prefix_text")));
    ...
    @Test(priority = 1, groups = {"Login page"}, enabled = true)
    public void TC_003()
    {
        /*Global wait.*/
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    ...
    @Test(priority = 2, groups = {"Login page"}, enabled = false)
    public void TC_004()
    {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        ...
        //clicking the mobile number input field and send the keys to it.
        wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.id("com.moai.android:id/edtMobileNumber"))).sendKeys("1111111111");
    ...
    @Test(priority = 3, groups = {"Login page"}, enabled = false)
    public void TC_005()
    {
    ...
    @Test(priority = 4, groups = {"Login page"}, enabled = false)
    public void TC_006()
    {
    ...
    @Test(priority = 5, groups = {"Login page"}, enabled = false)
    public void TC_007()
    {
    ...
    @Test(priority = 6, groups = {"Login page"}, enabled = false)
    public void TC_008()
    {
