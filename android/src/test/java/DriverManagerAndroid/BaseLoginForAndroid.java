...
public class BaseLoginForAndroid extends DriverManager {
    ...
    public void CoreLoginForAndroid(Boolean IsSkipped) throws Exception {
        ...
        LogUtil.info("Entering into Core login case fo Android.");
        ...
        try {
            ...
            Ok.click();
            LogUtil.info("*OK Button is found and its clicked");
        } catch (Exception e) {
            LogUtil.warning("Ok button is not found, we good to go with login");
        }
